                        ...
                        <div class="panel-body">
                           <form class="col-sm-6" enctype="multipart/form-data" action="{{url('/admin/add-product')}}" method="post" >{!! csrf_field() !!}
                              ...
                              <div class="form-group">
                                 ...
                                 <input type="text" class="form-control" placeholder="Enter product code Name" name="product_code" id="product_code" required>
                              </div>
                              <div class="form-group">
                                 <label>Product Color</label>
                                 <input type="text" class="form-control" placeholder="Enter Product Color" name="product_colour" id="product_colou r" required>
                              </div>
                              <div class="form-group">
                                 <label>Product_Description</label>
                                 <textarea name="product_description" id="product_desc" class="form-control"></textarea>
                              </div>
