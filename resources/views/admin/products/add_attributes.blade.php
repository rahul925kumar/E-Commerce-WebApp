          ...
          <div class="col-sm-12">
             <div class="panel panel-bd lobidrag">
                ...
                <form class="col-sm-6" enctype="multipart/form-data" action="{{url('/admin/add-attributes/'.$productDetails->id)}}" method="post"> {{csrf_field()}}
                      ...
                      <div class="form-group">
                         <label>Product Color</label> {{$productDetails->color_code}}
                      </div>
                      ...
                      <div class="form-group">
                            <div class="field_wrapper">
                                <div style="display:flex;">
                                    ...
                                    <a href="javascript:void(0);" class="add_button btn btn-primary" style="float:right" title="Add Field">Add</a>
                                </div>
                            </div>
                      </div>
                                 ...
                                 <form enctype="multipart/form-data" action="{{url('/admin/edit-attributes/'.$productDetails->id)}}" method="post"> {{csrf_field()}}
                                    ...
                                    <tbody>
                                       ...
                                       <td><input type="text" name="sku[]" value="{{$attribute->sku}}" style="text-align:center;"> </td>
                                          ...
                                          <td class="center">
                                             <div class="btn-group">
                                                   <input type="submit" value="update" class="btn btn-success" style="height:30px;padding-top:4px;margin-right: 10px;">
